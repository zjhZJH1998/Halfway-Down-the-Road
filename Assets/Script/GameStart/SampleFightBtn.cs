...
public class SampleFightBtn : MonoBehaviour
{
    ...
    private void resetResource()
    {
        ...
        PlayerPrefs.SetInt("ResourceGreenNum", 999);
        PlayerPrefs.SetInt("ResourceRedNum", 999);
        PlayerPrefs.SetInt("ResourceBlueNum", 999);
    }
