...
public class MinionArchor : MinionBase
{
    // Basic elements
    [SerializeField]
    private int ATK = 1;
    [SerializeField]
    private float ATKRange = 6f;
    [SerializeField]
    ...
    public override void Attack()
    {
        ...
        if (attackReady)
        {
            ...
            {
                GameObject go = Instantiate(arrowPrefab,transform.position,Quaternion.identity);
                go.GetComponent<Arrow>().SetTarget(target,ATK);
